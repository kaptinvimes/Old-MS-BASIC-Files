...
'**************************************************************************
'*   title: Gauge Calibration version 5.6                                 *
'*                                                                        *
'*                                                                        *
'*   last amended:04/08/10 (c) dcw 1990-2010                              *
'**************************************************************************
'**************************************************************************
'*   Constants                                                            *
'**************************************************************************
...
fcount% = 1
CLS
ME$ = " Afriso Eurogauge Ltd                         Calibration System Version 5.6"
CALL MainScreen
...
menu$(1) = "1. Scale in millibars"
menu$(2) = "2. Scale in degrees"
menu$(3) = "3. Analog Meter or 0-20mA"
...
'**************************************************************************
CASE 21
 ME$ = "Pressure: Horizontal Cylinder"
 CALL MainScreen
 CALL Pop
...
PRINT #1, "Afriso Eurogauge Ltd Calsys 5.6 ";
...
PRINT #1, USING "   Height/Diameter  ##### mm "; VesselHeight * C254
PRINT #1, STRING$(74, "-")
PRINT #1, "   " + scale$;
PRINT #1, TAB(21); inc$;
...
PRINT #1, USING "Height/Diameter ##### mm "; VesselHeight * C254;
PRINT #1, USING "  Working Range ##### mm "; ((VesselHeight - Centreline - Flange) * Density) * C254;
PRINT #1, USING "(#####.# mbar)"; ((((VesselHeight - Centreline - Flange) * Density) * C254) * .98066) / 10
PRINT #1, USING "Density #.#### kg/l "; Density;
PRINT #1, USING " AG C/L  #### mm/"; Centreline * C254;
PRINT #1, USING " AG Flange #### mm/"; Flange * C254
PRINT #1, STRING$(74, "-")
PRINT #1, "   " + scale$;
PRINT #1, TAB(21); inc$;
PRINT #1, TAB(50); "Degrees"
...
menu$(1) = "1. Total dish volume"
menu$(2) = "2. Partial dish volume"
menu$(3) = "3. Dish depth"
menu$(4) = "4. Main menu"
