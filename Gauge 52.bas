'**************************************************************************                                                  ³
'*   title: Gauge Calibration version 5.3                                 *
'*                                                                        *
'*                                                                        *
'*   last amended:28/04/05           (c) dcw 1990, 1999, 2000, 2001, 2005 *
'**************************************************************************
'**************************************************************************
'*   Constants                                                            *
'**************************************************************************
...
fcount% = 1
CLS
ME$ = " Afriso Eurogauge - East Grinstead.           Calibration System Version 5.2"
CALL mainscreen
...
PRINT #1, "Afriso Eurogauge Ltd Calsys 5.2  ";
...
END SELECT
 ...
 IF NOT Recoverable% THEN
	ME$ = ME$ + ", Abnormal Program Termination ...."
	ME% = StatusLine%(ME$)
	RESUME egress
 ELSE
